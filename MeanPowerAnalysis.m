...
%initiate movie to trace peaks over time
if movieBool
...
if saveBool
    saveas(gcf, [figureDir filesep 'PeaksTraceSTD.png'])
end
...
if saveBool
    saveas(gcf, [figureDir filesep 'PeaksTraceNoSTD.png'])
end
...
if saveBool
    saveas(gcf, [figureDir filesep 'MeanHeatMap.png'])
end
...
if saveBool
    saveas(gcf, [figureDir filesep 'MeanHeatMapWPeaks.png'])
end
...
if saveBool
    saveas(gcf, [figureDir filesep 'MeanHeatMapSTD.png'])
end
...
if saveBool
    saveas(gcf, [figureDir filesep 'MeanHeatMapNoise.png'])
end
